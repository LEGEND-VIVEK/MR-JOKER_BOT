...
PM_START_TEXT = """
*Hello there*, *I*'*m* [GROUP MANAGER](https://te.legra.ph/file/f4bb8c0c52345593dcaf8.jpg)
...
buttons = [
   ...
   # [
    ...
    [
        InlineKeyboardButton(text="➕ 𝗔𝗗𝗗 𝗚𝗥𝗢𝗨𝗣 𝗠𝗔𝗡𝗔𝗚𝗘𝗥 𝗧𝗢 𝗬𝗢𝗨𝗥 𝗚𝗥𝗢𝗨𝗣  ➕", url="https://t.me/pro_management_robot?startgroup=true"),
    ],
]
...
HELP_STRINGS = """
**SETTINGS**
**𝐂𝐥𝐢𝐜𝐤 𝐨𝐧 𝐭𝐡𝐞 𝐛𝐮𝐭𝐭𝐨𝐧𝐬 𝐛𝐞𝐥𝐨𝐰 𝐭𝐨 𝐠𝐞𝐭 𝐝𝐨𝐜𝐮𝐦𝐞𝐧𝐭𝐚𝐭𝐢𝐨𝐧 𝐚𝐛𝐨𝐮𝐭 𝐬𝐩𝐞𝐜𝐢𝐟𝐢𝐜 𝐦𝐨𝐝𝐮𝐥𝐞𝐬**[🤖](https://te.legra.ph/file/f4bb8c0c52345593dcaf8.jpg)"""



DONATE_STRING = """ @divya_066"""
...
def mrjoker_about_callback(update, context):
    ...
    if query.data == "mrjoker_":
        query.message.edit_text(
            ...
            f"\n\n 🔥 Join [SUPPORT GROUP](https://t.me/friendssreyh) To Keep Yourself Updated About {dispatcher.bot.first_name} 🔥"
            f"\n\n I have the normal GROUP MANAGING functions like flood control, a warning system etc but I mainly have the advanced and handy Antispam system and the SIBYL banning system which safegaurds and helps your group from spammers."
            f"\n\nI Can Manage Your Groups Smoothly, With Some Special Features [:)](https://te.legra.ph/file/f4bb8c0c52345593dcaf8.jpg)"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="𝗦𝗨𝗣𝗣𝗢𝗥𝗧 𝗚𝗥𝗢𝗨𝗣", url="https://t.me/FRIENDSSREYH"
                        ),
                    ],
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="𝗟𝗢𝗚'ꜱ 📋", url="https://t.me/FRIENDSSREYH"),
                 ],
                 [
                    InlineKeyboardButton(text="𝗦𝗨𝗣𝗣𝗢𝗥𝗧 👥", url= "https://t.me/FRIENDSSREYH"),
                 ],
        ...
        query.message.edit_text(
            ...
            f"\nHere Some Developers Helping in Making The GROUP MANAGER",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="𝘿𝙄𝙑𝙔𝘼-𝙂𝙐𝙋𝙏𝘼", url="t.me/divya_066"),
                    InlineKeyboardButton(text="𝙑𝙄𝙑𝙀𝙆-𝙆𝙐𝙈𝘼𝙍", url="t.me/vivek_99055"),
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤡 I'm *GROUP MANAGER*
                 \nHere is the [🤡Source Code🤡](SORRY! THIS BOT IS PRIVATE) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
